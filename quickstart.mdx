...
<Steps>
  <Step title="First Step">
    ...
    <CodeGroup>
    ```shell macOS
    go get github.com/ghostsecurity/bones
    ```
  ...
  <Step title="Second Step">
    Export API keys for the providers you'll be using in your project.
  ...
  <Step title="Third Step">
    ...
    import (
      ...
      "github.com/ghostsecurity/bones"
    )

    func main() {
      agent := bones.NewAgent()
    }
    ```
  </Step>
